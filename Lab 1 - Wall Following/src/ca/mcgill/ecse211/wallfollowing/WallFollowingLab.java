...
public class WallFollowingLab {
  ...
  private static final int bandCenter = 35; // Offset from the wall (cm) 30
  private static final int bandWidth = 6; // Width of dead band (cm)
  private static final int motorLow = 120; // Speed of slower rotating wheel (deg/sec) 120
  private static final int motorHigh = 280; // Speed of the faster rotating wheel (deg/sec) 300


  private static final Port usPort = LocalEV3.get().getPort("S1");
  // private static final Port touchPort = LocalEV3.get().getPort("S2");  // added by us
  ...
  public static void main(String[] args) {
    ...
    /* Setup touch sensor (our work)
    SensorModes touchSensor = new EV3TouchSensor(touchPort);	// create sensor instance and attach to port
    SampleProvider touchStatus = touchSensor.getMode("Distance");
    boolean touchData = touchSensor.getValue(); */
